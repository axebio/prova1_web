...
class Usuario{
  ...
  Usuario(this.estoque,this.laboratorio,this.fornecedor,this.precoCompra,this.precoVenda);
}
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  SizedBox(width: 30),
                  Container(
                    child: Icon(Icons.medication, size: 70, color: Theme.of(context).primaryColor),
                  ),
                  SizedBox(width: 80),
                  Container(
